...
import url, { URL as URL$1 } from 'url';
...
import { URL, HTTP_METHODS } from '@pollyjs/utils';
...
class HttpAdapter extends Adapter {
  ...
  async passthroughRequest(pollyRequest) {
    ...
    }, urlToOptions$1(new URL$1(pollyRequest.url))));
  ...
  async respondToRequest(pollyRequest, error) {
    ...
    const chunks = this.getChunksFromBody(body, headers);
    const stream = new Readable(); // Expose the response data as a stream of chunks since
    ...
    stream.push(null); // Create a promise that will resolve once the request
